...
import { IDeleteSite, IProductRequisitionInfo, ISite, IUserInfo } from '@/types'
import { useRequisitionStore } from '@/stores'
import { useTranslation } from 'react-i18next'
import React, { useState } from 'react'
import { useDeleteSite, useDeleteUserDepartment } from '@/hooks'
...
export const DialogDeleteUserDepartment: React.FC<IFormDeleteUserDepartmentProps> = ({ user }) => {
